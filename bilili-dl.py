...
def main():
    ...
    ##原来是120
    parser.add_argument("-t", "--num-thread", default=60,
                        type=int, help="最大下载线程数")
    parser.add_argument("-p", "--episodes", default="1", help="选集")
    ...
    parser.add_argument("--block-size", default=16*1024*1024, type=int,
                        help="分段下载器的块大小，默认为 4MB---8*1024*1024")
    ...
    if re.match(r"https?://www.bilibili.com/video/BV(.*?)", args.url) or \
