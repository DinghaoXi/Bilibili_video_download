...
from common import convert_danmaku
from downloader import BiliFileManager
...
def get_video(url):
    ...
    parser.add_argument("-t", "--num-thread", default=40,
    ...
    parser.add_argument("--block-size", default=8*1024*1024, type=int,
